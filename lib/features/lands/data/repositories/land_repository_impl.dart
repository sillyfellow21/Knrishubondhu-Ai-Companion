...
class LandRepositoryImpl implements LandRepository {
  ...
  Future<Either<String, Land>> addLand({
    ...
    try {
      ...
      try {
        ...
        Logger.info('Land synced to Supabase');
      } catch (e) {
        Logger.warning('Failed to sync land to Supabase: $e');
  ...
  Future<Either<String, Land>> updateLand({
    ...
    try {
      ...
      // Get existing land
      final existingResult = await getLandById(landId);
  ...
  Future<Either<String, void>> deleteLand(String landId) async {
    try {
      ...
      try {
        ...
        Logger.info('Land deleted from Supabase');
      } catch (e) {
        Logger.warning('Failed to delete land from Supabase: $e');
      }
  ...
  Future<Either<String, void>> syncLands() async {
    try {
      ...
      Logger.info('Lands synced successfully');
      return const Right(null);
    } catch (e) {
