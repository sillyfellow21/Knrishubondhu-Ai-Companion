...
class DatabaseService {
  ...
  Future<void> _onCreate(Database db, int version) async {
    ...
    await db.execute('CREATE INDEX idx_users_supabase_id ON users(supabase_id)');
    ...
    await db.execute('CREATE INDEX idx_chat_history_user_id ON chat_history(user_id)');
    await db.execute('CREATE INDEX idx_chat_history_session_id ON chat_history(session_id)');
    await db.execute('CREATE INDEX idx_weather_cache_location ON weather_cache(location)');
    await db.execute('CREATE INDEX idx_weather_cache_expires ON weather_cache(expires_at)');
  ...
  Future<List<Map<String, dynamic>>> getChatHistoryBySessionId(String sessionId) async {
    return await query(
      table: 'chat_history',
      where: 'session_id = ?',
      whereArgs: [sessionId],
