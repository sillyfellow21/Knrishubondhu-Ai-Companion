...
class SupabaseService {
  ...
  static Future<void> initialize() async {
    try {
      ...
      Logger.error('Failed to initialize Supabase', error: e, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  Future<void> updateData(String table, Map<String, dynamic> data, String matchColumn, dynamic matchValue) async {
    await update(table: table, data: data, matchColumn: matchColumn, matchValue: matchValue);
  }

  /// Delete data (backward compatibility wrapper)
  Future<void> deleteData(String table, String matchColumn, dynamic matchValue) async {
    await delete(table: table, matchColumn: matchColumn, matchValue: matchValue);
  }

  /// Query data (backward compatibility wrapper)
  Future<List<Map<String, dynamic>>> queryData(String table, {Map<String, dynamic>? filters}) async {
    try {
